...
const phcs = [
  {
    rank: "#01",
    name: "Villianur Health Center",
    zone: "North Coastal",
    infrastructure: 42,
    patientLoad: "Extremely High",
    score: 92,
  },
  {
    rank: "#02",
    name: "Bahour Wellness Unit",
    zone: "South Coastal",
    infrastructure: 55,
    patientLoad: "High",
    score: 88,
...
>
  ...
  <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
    ...
    <p className="text-center text-sm text-slate-500">
      Average infrastructure and staffing readiness
    </p>
